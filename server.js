...
const ENABLE_DOMAIN_FORWARDING = false; // Toggle: set to false to disable
const TARGET_DOMAIN = 'htwebz.duckdns.org';
// ============================================
...
app.get('/', (req, res) => {
  res.send('Serving all files from the HtWebz folder! Navigate to /file to access specific files.');
});
