 ...
 * @public
 */
NotificationInstancerData.NotificationInnerContentsTemplate = `
 ...
 * @public
 */
NotificationInstancerData.NotificationTimelineDividerContents = `
...
class UserNotification {
    ...
    constructor(NotificationMessage, NotificationLabelText, AutoRemovalDuration) {
         ...
         * @private
         */
        this.FormatedNotificationClassName = null;
        /**
         *
         * @type {boolean}
         */
