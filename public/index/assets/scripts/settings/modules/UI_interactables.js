...
class SettingMenuInstancer {
  CreateToggleSettingElement(switch_toggle_name, switch_toggle_IDNAME) {
  ...
  /**
   * Creates an new instance of **DropdownInputMenu**.
   * 
   * ---
   * 
   * NOTES:
   * - Applies a event to the **DropdownInputMenu**; when value changes.
   * - 
   * 
   * ---
   * 
   * @param {string | undefined} DropdownContextElementName 
   * @returns {void}
   */
  CreateDropdownMenuSettingElement(DropdownContextElementName) {
    if (DropdownContextElementName === undefined) {
      DropdownContextElementName = "";
    }
    ...
    try {
       ...
       * ---
       * 
       * @type {DropdownContextDOM}
       */
      let DropdownContextShadowRoot = {
        _CONTEXT: [],
        NAME: DropdownContextElementName,
        ROOT: null,
      };
...
export {
  ToggleSwitchCreationError,
  SettingMenuInstancer,
};
